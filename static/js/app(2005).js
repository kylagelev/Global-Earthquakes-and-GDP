     ...
     labelsGroup.append("text")
        ...
        imageGroup.on("mouseover", function(gdpData) {
          toolTip.style("display", "block")
              .html(
                `<strong>Year:${dateFormatter(gdpData[5].Year)}<strong><hr>GDP Growth:${(gdpData[5].GDPgrowth)}
            %<hr>Location:Sumatra`)
      ...
      .text("GDP Growth (%)")
        ...
        .transition()
        .duration(1000)
        .attr("cx", data => xTimeScale(data[5].Year))
        .attr("cy", data => yLinearScale(data[5].GDPgrowth));
      
        chartGroup.selectAll("image")
        .transition()
        .duration(1000)
        .attr("x", data => xTimeScale(data[5].Year))
        .attr("y", data => yLinearScale(data[5].GDPgrowth));
    })
  }
      ...
      var labelsGroup = chartGroup.append("g")
       ...
       labelsGroup.append("text")
          ...
          imageGroup.on("mouseover", function(gdpData) {
            toolTip.style("display", "block")
                .html(
                  `<strong>Year:${dateFormatter(gdpData[5].Year)}<strong><hr>GDP:$${(gdpData[5].GDP)}
              <hr>Location:Sumatra`)
                .style("left", d3.event.pageX + "px")
                .style("top", d3.event.pageY + "px");
          })
        ...
        .text("GDP ($)")
          ...
          .duration(1000)
          .attr("cx", data => xTimeScale(data[5].Year))
          .attr("cy", data => yLinearScale(data[5].GDP));
      ...
      var labelsGroup = chartGroup.append("g")
       ...
       labelsGroup.append("text")
          ...
          imageGroup.on("mouseover", function(gdpData) {
            toolTip.style("display", "block")
                .html(
                  `<strong>Year:${dateFormatter(gdpData[5].Year)}<strong><hr>GDP Per Capita:$${(gdpData[5].GDPpercapita)}
              <hr>Location:Sumatra`)
                .style("left", d3.event.pageX + "px")
                .style("top", d3.event.pageY + "px");
          })
        ...
        .text("GDP Per Capita ($)")
          ...
          .duration(1000)
          .attr("cx", data => xTimeScale(data[5].Year))
          .attr("cy", data => yLinearScale(data[5].GDPpercapita));
        
          chartGroup.selectAll("image")
          .transition()
          .duration(1000)
          .attr("x", data => xTimeScale(data[5].Year))
          .attr("y", data => yLinearScale(data[5].GDPpercapita));
      })
